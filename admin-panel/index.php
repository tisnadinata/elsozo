...
<html lang="en">
  <head>
    ...
    <title>ELSOZO Admin Dashboard </title>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-file"></i> Kelola Event <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="?page=artikel-tambah">Tambah Event</a></li>
                      <li><a href="?page=artikel-daftar">Daftar Event</a></li>
                    </ul>
                  </li>
				  <li><a href="?page=subscriber"><i class="fa fa-envelope"></i> Daftar Subsriber</a></li>                  
			...
			<div class="row">
				<?php
					...
					switch($page){
						...
						case 'artikel-tambah' : include 'artikel_tambah.php';break;
						case 'artikel-daftar' : include 'artikel_daftar.php';break;
						case 'pengaturan' : include 'pengaturan.php';break;
						case 'transaksi' : include 'transaksi.php';break;
						case 'subscriber' : include 'subscribe.php';break;
